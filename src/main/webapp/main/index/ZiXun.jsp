...
<div class="clear"></div>
		...
		<div class="grid_7 slide-list-container" id="slide">
			<ul class="slide-list">
			<s:iterator value="newsZiXun.imageNews" status="vs">
		...
		<div class="grid_10">
			<div class="mod-box-horizon mod-box-horizon-last news-block"
				id="jiaodianxinwen">
				<div class="mod-hd"><span class="more"><a href="c.do?id=1" target="_blank">更多</a></span><a href="c.do?id=6" target="_blank">综合咨询</a></div>
				<div class="mod-bd" style="height:240px;">
					<div class="headline">
						<h3 class="mod-hd">
							<a href="news.do?id=<s:property value="newsZiXun.firstNews.id"/>"
								target="_blank"><s:property value="newsZiXun.firstNews.title" /></a>
						</h3>
						<div class="mod-bd">
							<ul class="news-list clear-fix active tab-pannel-item">
								<s:iterator value="newsZiXun.secondNews" status="vs">
					...
					<ul class="mod-article-list">
						<s:iterator value="newsZiXun.thirdNews" status="vs">
		...
		<div class="grid_7">
			<div class="mod-box-horizon tab-list lxctab">
				<div class="mod-hd tab-hd">
					<h3 class="tab-hd-item active"><a href="sc.do?id=${newsZiXun.smallCategory1.id}" target="_blank">${newsZiXun.smallCategory1.name}</a></h3>
					<h3 class="tab-hd-item"><a href="sc.do?id=${newsZiXun.smallCategory2.id}" target="_blank">${newsZiXun.smallCategory2.name}</a></h3>
					<h3 class="tab-hd-item last"><a href ="sc.do?id=${newsZiXun.smallCategory3.id}" target="_blank">${newsZiXun.smallCategory3.name}</a></h3>
				</div>
