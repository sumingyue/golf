	...
	<div class="container">
		...
		<div class="club-detail">
			<div class="span7 myhidden border" style="height: 350px;">
				<img src="${drivingRange.image.path}" class="drivingRange-img">
			</div>
			<div class="span5 myhidden border" style="height: 350px;">
				<div>
					...
					<table class="table table-striped table-bordered table-hover">
						<tr>
							<td>名称</td>
							<td>${drivingRange.name}</td>
						</tr>
						<tr>
							<td>地址</td>
							<td>${drivingRange.address}</td>
						</tr>
						<tr>
							<td>电话</td>
							<td>${drivingRange.phone}</td>
						</tr>
					</table>
				</div>
			</div>
