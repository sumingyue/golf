    ...
    <div class="row-fluid">
      ...
      <div class="span10">
				...
				<table align="center" cellpadding="2" cellspacing="1" width="100%">
					...
					<tr>
						<td class="left" width="15%" >俱乐部名称<span style='color: red'>*</span></td>
						<td class="right"><input type="text" size="40" name="court.name" value="<s:property value="court.name"/>"/></td>
					</tr>
					<tr>
						<td class="left">俱乐部地址<span style='color: red'>*</span></td>
					...
					<tr>
						<td class="left">俱乐部说明<span style='color: red'>*</span></td>
						<td class="right"><textarea  name="court.introduction"  rows="5" cols="80"><s:property value="court.name"/></textarea>
						</td>
					</tr>
					<tr>
						<td class="left">俱乐部介绍<span style='color: red'>*</span></td>
						<td class="right"><textarea id="editor1" name="court.customIntro"
								rows="30"><s:property value="court.customIntro"/></textarea></td>
					</tr>
					<tr>
						<td class="left">俱乐部奖项<span style='color: red'>*</span></td>
					...
					<tr>
						<td class="left">行车路线<span style='color: red'>*</span></td>
