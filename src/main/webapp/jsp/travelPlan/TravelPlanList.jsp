      ...
      <div class="span10">
			<table class="table table-striped table-bordered" id="contents">
				<thead><tr class="title">
					<th width="5%">序号</th>
					<th width="15%">旅游套餐名称</th>
					<th width="70%">行程安排名称</th>
					<th width="10%">操作&nbsp;&nbsp;&nbsp;&nbsp;<a href="travelPlanAdd.do" class="btn btn-primary  btn-small" >新增</a></th>
				</tr></thead><tbody>
				<s:iterator value="travelPlans" status="vs">
					...
					<a class="btn btn-danger  btn-small delete" href="travelPlanDelete.do?travelPlanId=<s:property value="id"/>">删除</a></td>
					</tr>
				</s:iterator></tbody>
			</table>
      </div>
