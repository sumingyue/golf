      ...
      <div class="span10">
			...
			<form action="imageSpecialDetailUpdateSubmit.do" id="form" method="post"  
				...
				<table align="center" cellpadding="2" cellspacing="1" width="100%">
					<tr>
						...
						<td class="right">
							<s:select name="imageSpecialDetail.imageSpecialId" id="imageSpecialId"
								list="imageSpecials" listKey="id" listValue="name"  value="imageSpecialDetail.imageSpecialId" theme="simple" >
							</s:select>
						</td>
					</tr>
					<tr>
						<td class="left">修改图片<span style='color: red'>*</span></td>
					...
					<tr>
						<td class="left" width="30%">图片简介<span style='color: red'>*</span></td>
						<td class="right"><textarea  name="imageSpecialDetail.imageDes"  rows="5" cols="60"><s:property value='imageSpecialDetail.imageDes'/></textarea>
						</td>
					</tr>
					<tr>
