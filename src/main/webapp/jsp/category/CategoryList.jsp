...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
<!--         <h4 style="text-align:center">新闻一级分类管理</h4>
 -->			<table  align="center" cellpadding="2" cellspacing="1"  class="table">
				<tr class="title">
					<th width="5%">序号</th>
					<th width="75%">名称</th>
					<th width="10%">管理</th>
					<th width="10%">操作&nbsp;&nbsp;&nbsp;&nbsp;<a href="categoryAdd.do">新增</a></th>
				</tr>
				<s:iterator value="categories" status="vs">
					<tr>
					<td><s:property value='#vs.index+1'/></td>
					<td><s:property value="name" /></td>
					<td><a href="smallCategoryList.do?categoryId=<s:property value="id"/>">管理子类</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td><a href="categoryUpdate.do?categoryId=<s:property value="id"/>">编辑</a> &nbsp;&nbsp;&nbsp;&nbsp;
					<a href="categoryDelete.do?categoryId=<s:property value="id"/>" class="delete">删除</a></td>
					</tr>
				</s:iterator>
			</table>
				</br>
