...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="travelHotelImageAddSubmit.do" id="form" method="post"  
				enctype="multipart/form-data">
				<table class="table table-striped table-bordered" width="100%">
					<tr><td colspan='4'>
						<h4 style="text-align:center">新增高尔夫旅游酒店图片信息</h4>
					</td></tr>
					<tr>
						<td class="left" width="40%" colspan="2">旅游酒店<span class='red'>*</span></td>
						<td class="right" colspan="2">
							<s:select name="travelHotelImage.travelHotelId" id="travelHotelId"
								list="travelHotels" listKey="id" listValue="name"  theme="simple" >
							</s:select>
						</td>
					</tr>
					<tr>
						<td class="left">旅游酒店图片01<span class='red'>*</span></td>
					...
					<tr>
						<td class="left">旅游酒店图片02<span class='red'>*</span></td>
						<td class="right"><input type="file" name="uploads"
							id="fileUpload_upload"></td>
					...
					<tr>
						<td class="left">旅游酒店图片03<span class='red'>*</span></td>
						<td class="right"><input type="file" name="uploads"
							id="fileUpload_upload"></td>
					...
					<tr>
						<td class="left">旅游酒店图片04<span class='red'>*</span></td>
						<td class="right"><input type="file" name="uploads"
							id="fileUpload_upload"></td>
					...
					<tr>
						<td class="left">旅游酒店图片05<span class='red'>*</span></td>
						<td class="right"><input type="file" name="uploads"
							id="fileUpload_upload"></td>
